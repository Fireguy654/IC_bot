...
KEYBOARD = [["/something", "/ch_study_mode", "/ch_answer_mode"],
            ["/gif", "/create_meme", "/translate"]]
...
HELP_TEXT = 'Введите "/something", чтобы я сгенерировал вам предложение,\n' + \
    ...
    'При наборе "/get_music <количество> <название>" ' + \
    'вы получите несколько популярных треков по заданному названию.\n' + \
    '"/translate"  Откроет вам возможность перевести фразу на множество языков.'
